...
public class BaseConstants {
    ...
    public static final String PATTERN_TIMESTAMP_E = "ddMMyyyy";
    public static final String PATTERN_TIMESTAMP_E_HYPHEN = "dd-MM-yyyy";
    public static final String PATTERN_TIMESTAMP_E_SLASH = "dd/MM/yyyy";
    ...
    //***** call back method *****
    //***** getter and setter *****
    public static final List<AssignmentState> DEFAULT_RETURN_STATES = Arrays.asList(AssignmentState.WAITING_FOR_RETURNING,AssignmentState.COMPLETED);
